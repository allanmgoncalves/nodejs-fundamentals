...
Nesse desafio, foi criado uma aplicação para continuar treinando o que foi aprendendido até agora no Node.js junto ao TypeScript, utilizando o conceito de models, repositories e services!
